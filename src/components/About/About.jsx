...
const About = () => {
  ...
  return (
    <>
      <div className="about-banner">
        <div className="about-banner-front">
          <div className="aboutleft">
            <div className="aboutleftsec fromtop-anim">Meshly</div>
            <p className="abouleftseccont fade-effect">
              A 3d Marketplace for immersive augmented reality shopping
              experiences.
            </p>
          </div>
      ...
      <div>
        <h1 className="second-head fromtop-anim">Why meshly ?</h1>
      ...
      {/* <div className="about-goals-box">
            ...
            <div><h1 className="second-head fromtop-anim">Project Admin</h1>
                <a><div className="about-admin-box fade-effect"><img className="about-admin-img" src="https://avatars.githubusercontent.com/u/56475750?v=4" /><p className="about-admin">Jay</p></div></a></div>
